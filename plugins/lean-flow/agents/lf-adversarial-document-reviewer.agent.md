...
- **Internal contradictions** or terminology drift -- lf-coherence-reviewer owns these
- **Technical feasibility** or architecture conflicts -- lf-feasibility-reviewer owns these
- **Scope-goal alignment** or priority dependency issues -- lf-scope-guardian-reviewer owns these
- **UI/UX quality** or user flow completeness -- lf-design-lens-reviewer owns these
- **Security implications** at plan level -- lf-security-lens-reviewer owns these
- **Product framing** or business justification quality -- lf-product-lens-reviewer owns these
