...
5. **Apply YAGNI Rigorously**:
   ...
   - Never flag `docs/plans/*.md` or `docs/solutions/*.md` for removal — these are lean flow pipeline artifacts created by `/lf-plan` and used as living documents by `/lf-work-lite`
