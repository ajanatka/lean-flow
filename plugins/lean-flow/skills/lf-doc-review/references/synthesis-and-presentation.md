...
- Requirements document → `lf-plan`
- Plan document → `lf-work-lite`
...
- Do not modify caller skills (lf-brainstorm, lf-plan, or external plugin skills that invoke lf-doc-review)
