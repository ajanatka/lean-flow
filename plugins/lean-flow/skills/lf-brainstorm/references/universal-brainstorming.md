...
**Then offer next steps** using the platform's blocking question tool (see SKILL.md Interaction Rule 4). Never silently skip the question.

**Question:** "Brainstorm wrapped. What would you like to do next?"

- **Create a plan** → hand off to `/lf-plan` with the decided goal and constraints
