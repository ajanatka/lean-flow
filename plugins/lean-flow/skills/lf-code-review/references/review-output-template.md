...
- **Learnings & Past Solutions section** -- results from lf-learnings-researcher, with links to docs/solutions/ files
- **Agent-Native Gaps section** -- results from lf-agent-native-reviewer. Omit if no gaps found.
