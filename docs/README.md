...
The reference docs live here. You don't need all of them on day one — pick the path that matches what you're trying to do.
...
5. [`cross-client-contract.md`](cross-client-contract.md) — canonical prompts, Claude/Codex model and permission mappings, deterministic generation, and new-session activation.
...
- [`cross-client-contract.md`](cross-client-contract.md) — build and validate the Codex adapter without touching live runtime homes.
